        ...
        <div class="col-md-6">
          ...
          <b-form-radio-group class="mt-3" :state="form.selectedSex !== ''">
            ...
            >
              ...
              <b-form-radio value="false" disabled>Nữ</b-form-radio>
            </b-form-radio-group>
          </b-form-radio-group>

          <!-- Trường tình trạng -->
          <b-form-radio-group class="mt-2" :state="form.selectedStatus !== ''">
            <label
              >Tình trạng
              <span style="color: red; margin-left: 2px">*</span>
            </label>
  ...
  methods: {
    ...
    async onSubmit() {
      try {
        ...
        this.showSuccessToast('Thêm bố vào phả đồ thành công')
      } catch (error) {
        // eslint-disable-next-line no-console
        console.log(error)

        this.showErrorToast('Có lỗi xảy ra khi thêm bố vào phả đồ!')
      }
    },
  },
}
